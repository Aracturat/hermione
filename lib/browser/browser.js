...
const {mkCallstackHistory, mkDryCallstackHistory} = require('./history');
...
module.exports = class Browser {
    ...
    constructor(config, id, version) {
        ...
        this._shouldSaveHistory = config.saveHistory;
    ...
    flushHistory() {
        return this._callstackHistory.flush();
    }
    ...
    _addHistory() {
        this._callstackHistory = this._shouldSaveHistory
            ? mkCallstackHistory(this._session)
            : mkDryCallstackHistory(this._session);
    }
